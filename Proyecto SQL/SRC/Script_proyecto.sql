...
SELECT ROUND(VARIANCE(replacement_cost),2) AS varianza_replacement_cost
FROM film;
...
FROM actor a
LEFT JOIN film_actor fa ON a.actor_id = fa.film_id
LEFT JOIN film f ON fa.actor_id = f.film_id
GROUP BY "a"."actor_id",
  "a"."first_name",
 "a"."last_name"
